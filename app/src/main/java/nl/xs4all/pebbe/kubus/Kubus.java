...
public class Kubus {
    ...
    public void draw(float[] mvpMatrix) {
        ...
        MyGLRenderer.checkGlError("glGetAttribLocation position");
        ...
        MyGLRenderer.checkGlError("glEnableVertexAttribArray color");
        GLES20.glVertexAttribPointer(
        ...
        MyGLRenderer.checkGlError("glDisableVertexAttribArray colorHandle");
        GLES20.glDisableVertexAttribArray(mPositionHandle);
        MyGLRenderer.checkGlError("glDisableVertexAttribArray positionHandle");
    }
}
